        ...
        <div>
            ...
            <form onSubmit={handleAddJob} className="card-body">
                ...
                <div className="form-control">
                    ...
                    <input type="text" name='company_logo' readOnly defaultValue={'https://is1-ssl.mzstatic.com/image/thumb/Purple115/v4/da/30/25/da30259e-b408-b4bc-33d4-fd4f368750ea/AppIcon-1x_U007emarketing-4-0-85-220.png/1200x630wa.png'} placeholder="Company Logo URL" className="input input-bordered" required />
                </div>
                {/* submit button */}
